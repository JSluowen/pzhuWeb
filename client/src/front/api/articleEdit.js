...
const ArticleEdit = {
    ...
    uploadArticleInfo(params) {
        return new Promise((resolve, reject) => {
            axios.post(`${base.uploadArticleInfo}`, params).then(res => {
                resolve(res.data)
            }).catch(err => {
                reject(err.data)
            })
    ...
    uploadArticleeCover(params) {
        return new Promise((resolve, reject) => {
            axios.post(`${base.uploadArticleeCover}`, params).then(res => {
                resolve(res.data)
            }).catch(err => {
                reject(err.data)
            })
    ...
    delCoverImg(params) {
        return new Promise((resolve, reject) => {
            axios.post(`${base.delCoverImg}`, params).then(res => {
                resolve(res.data)
            }).catch(err => {
                reject(err.data)
            })
    ...
    uploadArticleResource(params) {
        return new Promise((resolve, reject) => {
            axios.post(`${base.uploadArticleResource}`, params).then(res => {
                resolve(res.data)
            }).catch(err => {
                reject(err.data)
            })
