              ...
              <TabPane tab="资源列表" key="1">
                <div className="back-resource-container-list">
                  ...
                  <div className="back-resource-container-list-header">
                    <div className="back-resource-container-list-header-item">标题</div>
                    <div className="back-resource-container-list-header-item">类别</div>
                    <div className="back-resource-container-list-header-item">附件</div>
                    <div className="back-resource-container-list-header-item">作者</div>
                    <div className="back-resource-container-list-header-item">发布时间</div>
                    <div className="back-resource-container-list-header-item">操作</div>
                  </div>
                    ...
                    {this.state.resourceList.length !== 0 ? (
                      <div>
                        {this.state.resourceList.map((item, index) => {
                          return (
                            <div key={item.id} className="back-resource-container-list-body-list">
                              <div className="back-resource-container-list-body-list-item">{item.title}</div>
                              ...
                              <div className="back-resource-container-list-body-list-item">{item.created_at}</div>
                              <div className="back-resource-container-list-body-list-item">
                                {item.link ? (
                                  <Button type="primary">
                      ...
                      <div className="back-resource-container-list-body-nullData">暂无数据</div>
                    )}
                  </div>
                </div>
              </TabPane>
