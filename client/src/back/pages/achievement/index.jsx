...
class Achievement extends Component {
  ...
  isShow = (checked, event) => {
    let id = event.currentTarget.getAttribute('achid');
    const params = {
      checked: checked,
      id: id
    }
                        ...
                        <div>
                          {
                            this.state.achievementList.map((item, index) => {
                              return <div key={item.id} className='back-achievement-container-list-body-list'>
                                ...
                                <div className='back-achievement-container-list-body-list-item'>
                                  <Switch achid={item.id} onClick={this.isShow} checkedChildren="是" unCheckedChildren="否" defaultChecked={item.show ? true : false} />
                                </div>
                                <div className='back-achievement-container-list-body-list-item'>
