        ...
        <div className="back-user-header">
          ...
          <div className="back-user-header-item">
            <Progress
              ...
              strokeColor="#2db7f5"
              type="circle"
              percent={this.state.gradeGroup[1] || 0}
            />
            <p>后台</p>
          </div>
          <div className="back-user-header-item">
            <Progress
              ...
              strokeColor="#87d068"
              type="circle"
              percent={this.state.gradeGroup[2] || 0}
            />
            <p>算法</p>
          </div>
          <div className="back-user-header-item">
            <Progress
              ...
              strokeColor="#108ee9"
              type="circle"
              percent={this.state.gradeGroup[3] || 0}
            />
            <p>全栈</p>
          </div>
        </div>
            ...
            <Tabs activeKey={this.state.activeKey} onChange={this.onChangeActiveKey}>
              ...
              <TabPane tab="审核成员" key="2">
                <div className="back-user-body-review-header">
                  <div className="back-user-body-review-header-item">学号</div>
                  <div className="back-user-body-review-header-item">姓名</div>
                  <div className="back-user-body-review-header-item">邮箱</div>
                  <div className="back-user-body-review-header-item">申请时间</div>
                  <div className="back-user-body-review-header-item">操作</div>
                </div>
                  ...
                  {this.state.reviewUser.length !== 0 ? (
                    <div>
                      {this.state.reviewUser.map((item, index) => {
                        return (
                          <div key={item.id} className="back-user-body-review-body-list">
                            <div className="back-user-body-review-body-list-item">{item.id}</div>
                            <div className="back-user-body-review-body-list-item">{item.name}</div>
                    ...
                    <div className="back-user-body-review-body-nullData">暂无审核信息</div>
                  )}
                </div>
              </TabPane>
