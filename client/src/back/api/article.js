...
const Article = {
  ...
  deleteArticle(params) {
    return new Promise((resolve, reject) => {
      axios
        .post(`${base.deleteArticle}`, params)
        .then(res => {
          resolve(res.data);
        })
        .catch(err => {
  ...
  onSerachArticle(params) {
    return new Promise((resolve, reject) => {
      axios
        .post(`${base.onSerachArticle}`, params)
        .then(res => {
          resolve(res.data);
        })
        .catch(err => {
  ...
  delArticleTag(params) {
    return new Promise((resolve, reject) => {
      axios
        .post(`${base.delArticleTag}`, params)
        .then(res => {
          resolve(res.data);
        })
        .catch(err => {
  ...
  addArticleTag(params) {
    return new Promise((resolve, reject) => {
      axios
        .post(`${base.addArticleTag}`, params)
        .then(res => {
          resolve(res.data);
        })
        .catch(err => {
  ...
  uploadBackArticle(params) {
    return new Promise((resolve, reject) => {
      axios
        .post(`${base.uploadBackArticle}`, params)
        .then(res => {
          resolve(res.data);
        })
        .catch(err => {
